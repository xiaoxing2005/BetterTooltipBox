    ...
    public void loader() {
        ...
        if (ConfigManager.Instance.TooltipsTextureList.containsKey("defaultTexture")) {
            ...
            defaultTexture = new TooltipsTexture(
                ...
                new int[][] { { 0, 224, 255, 255, 0, 224, 255, 255, }, { 0, 224, 255, 255, 0, 224, 255, 255, },
                    { 0, 224, 255, 255, 0, 224, 255, 255, }, { 0, 224, 255, 255, 0, 224, 255, 255, },
                    { 0, 224, 255, 0, 0, 224, 255, 255, } },
                15,
                13);
            defaultTexture.addTextureFragment(new TextureFragment(Top_Center, 15, 13, 0, 0, 15, 13, 0, -12));
        ...
        ULV = new TooltipsTexture(
            ...
            new int[][] { { 184, 103, 89, 255, 184, 103, 89, 255, }, { 216, 136, 123, 255, 216, 136, 123, 255, },
                { 184, 103, 89, 255, 216, 136, 123, 255, }, { 184, 103, 89, 255, 216, 136, 123, 255, },
                { 184, 103, 89, 0, 216, 136, 123, 255, } },
            64,
            240);
        ...
        LV = new TooltipsTexture(
            ...
            new int[][] { { 61, 57, 52, 255, 61, 57, 52, 255, }, { 74, 70, 65, 255, 74, 70, 65, 255, },
                { 61, 57, 52, 255, 74, 70, 65, 255, }, { 61, 57, 52, 255, 74, 70, 65, 255, },
                { 61, 57, 52, 0, 74, 70, 65, 255, } },
            64,
            240);
        int level = 1;
        ...
        MV = new TooltipsTexture(
            ...
            new int[][] { { 51, 74, 76, 255, 51, 74, 76, 255, }, { 122, 157, 174, 255, 122, 157, 174, 255, },
                { 51, 74, 76, 255, 122, 157, 174, 255, }, { 51, 74, 76, 255, 122, 157, 174, 255, },
                { 51, 74, 76, 0, 122, 157, 174, 255, } },
            64,
            240);
        ...
        HV = new TooltipsTexture(
            ...
            new int[][] { { 93, 93, 106, 255, 93, 93, 106, 255, }, { 206, 206, 220, 255, 206, 206, 220, 255, },
                { 93, 93, 106, 255, 206, 206, 220, 255, }, { 93, 93, 106, 255, 206, 206, 220, 255, },
                { 93, 93, 106, 0, 206, 206, 220, 255, } },
            64,
            240);
        ...
        EV = new TooltipsTexture(
            ...
            new int[][] { { 83, 74, 87, 255, 83, 74, 87, 255, }, { 151, 123, 160, 255, 151, 123, 160, 255, },
                { 83, 74, 87, 255, 151, 123, 160, 255, }, { 83, 74, 87, 255, 151, 123, 160, 255, },
                { 83, 74, 87, 0, 151, 123, 160, 255, } },
            64,
            240);
        ...
        IV = new TooltipsTexture(
            ...
            new int[][] { { 53, 67, 110, 255, 53, 67, 110, 255, }, { 53, 67, 110, 255, 53, 67, 110, 255, },
                { 53, 67, 110, 255, 53, 67, 110, 255, }, { 53, 67, 110, 255, 53, 67, 110, 255, },
                { 53, 67, 110, 0, 53, 67, 110, 255, } },
            64,
            240);
        ...
        LuV = new TooltipsTexture(
            ...
            new int[][] { { 91, 64, 95, 255, 91, 64, 95, 255, }, { 88, 62, 91, 255, 88, 62, 91, 255, },
                { 91, 64, 95, 255, 88, 62, 91, 255, }, { 91, 64, 95, 255, 88, 62, 91, 255, },
                { 91, 64, 95, 0, 88, 62, 91, 255, } },
            64,
            240);
        ...
        ZPM = new TooltipsTexture(
            ...
            new int[][] { { 47, 35, 67, 255, 47, 35, 67, 255, }, { 121, 110, 138, 255, 121, 110, 138, 255, },
                { 47, 35, 67, 255, 121, 110, 138, 255, }, { 47, 35, 67, 255, 121, 110, 138, 255, },
                { 47, 35, 67, 0, 121, 110, 138, 255, } },
            64,
            240);
        ...
        UV = new TooltipsTexture(
            ...
            new int[][] { { 74, 221, 244, 255, 74, 221, 244, 255, }, { 61, 72, 193, 255, 61, 72, 193, 255, },
                { 74, 221, 244, 255, 61, 72, 193, 255, }, { 74, 221, 244, 255, 61, 72, 193, 255, },
                { 74, 221, 244, 0, 61, 72, 193, 255, } },
            64,
            240);
        ...
        UHV = new TooltipsTexture(
            ...
            new int[][] { { 242, 146, 235, 255, 242, 146, 235, 255, }, { 167, 42, 104, 255, 167, 42, 104, 255, },
                { 242, 146, 235, 255, 167, 42, 104, 255, }, { 242, 146, 235, 255, 167, 42, 104, 255, },
                { 242, 146, 235, 0, 167, 42, 104, 255, } },
            64,
            240);
        ...
        UEV = new TooltipsTexture(
            ...
            new int[][] { { 73, 99, 0, 255, 73, 99, 0, 255, }, { 153, 208, 0, 255, 153, 208, 0, 255, },
                { 73, 99, 0, 255, 153, 208, 0, 255, }, { 73, 99, 0, 255, 153, 208, 0, 255, },
                { 73, 99, 0, 0, 153, 208, 0, 255, } },
            64,
            240);
        ...
        UIV = new TooltipsTexture(
            ...
            new int[][] { { 239, 240, 245, 255, 239, 240, 245, 255, }, { 206, 209, 225, 255, 206, 209, 225, 255, },
                { 239, 240, 245, 255, 206, 209, 225, 255, }, { 239, 240, 245, 255, 206, 209, 225, 255, },
                { 239, 240, 245, 0, 206, 209, 225, 255, } },
            64,
            240);
        ...
        UMV = new TooltipsTexture(
            ...
            new int[][] { { 129, 32, 167, 255, 129, 32, 167, 255, }, { 169, 47, 224, 255, 169, 47, 224, 255, },
                { 129, 32, 167, 255, 169, 47, 224, 255, }, { 129, 32, 167, 255, 169, 47, 224, 255, },
                { 129, 32, 167, 0, 169, 47, 224, 255, } },
            64,
            240);
        ...
        UXV = new TooltipsTexture(
            ...
            new int[][] { { 208, 195, 98, 255, 208, 195, 98, 255, }, { 232, 107, 41, 255, 232, 107, 41, 255, },
                { 208, 195, 98, 255, 232, 107, 41, 255, }, { 208, 195, 98, 255, 232, 107, 41, 255, },
                { 208, 195, 98, 0, 232, 107, 41, 255, } },
            64,
            240);
        ...
        MAX = new TooltipsTexture(
            ...
            new int[][] { { 174, 106, 187, 255, 174, 106, 187, 255, }, { 83, 71, 108, 255, 83, 71, 108, 255, },
                { 174, 106, 187, 255, 83, 71, 108, 255, }, { 174, 106, 187, 255, 83, 71, 108, 255, },
                { 174, 106, 187, 0, 83, 71, 108, 255, } },
            64,
            240);
