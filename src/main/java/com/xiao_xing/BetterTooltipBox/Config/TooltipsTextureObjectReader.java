        ...
        while (!jsonReader.nextIfObjectEnd()){
            ...
            switch (key){
                ...
                case "FragmentList" -> {
                    ...
                    jsonReader.nextIfObjectStart();
                    while (!jsonReader.nextIfObjectEnd()){
                        TooltipsTexture.TextureFragmentType fragmentType = TooltipsTexture.TextureFragmentType.valueOf(jsonReader.readFieldName());
                        int x = 0;
                        int y = 0;
                        int FragmentWidth = 0;
                        ...
                        textureFragments.add(new TooltipsTexture.TextureFragment(fragmentType,width,height,x,y,FragmentWidth,FragmentHeight,offset[0],offset[1]));
                   }
                }
                default -> jsonReader.skipValue();
           }
        }
        TooltipsTexture texture = new TooltipsTexture(textureName,resourceLocation,backgroundColor,lineColor,width,height);
